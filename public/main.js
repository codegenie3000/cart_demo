...
const overlay = (function() {
    const fadeIn = function() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.custom-overlay').fadeIn('fast', function() {
            // animation complete
        });
    };

    const fadeOut = function() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.custom-overlay').fadeOut('fast', function() {
            // animation complete
        });
    };
...
const productDetail = {
    addToCart: function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#add-to-cart').submit(function(e) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax(uri, {
...
const cart = {
    changeQty: function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#cart').find('select.change-qty').change(function (e) {
            e.preventDefault();
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax('/cart/change_qty', {
    ...
    checkout: function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#cart').find('#checkOut').click(function (e) {
...
const billingFunc = {
    init: function () {
        billingFunc.$checkout01 = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.step01');
    ...
    enableNextButtonOnLoad: function () {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.required').each(function () {
    ...
    fieldsCompleteCheck: function () {
        const $button = billingFunc.$form.find(':button');
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.required').on('input propertychange paste', function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.required').each(function () {
                if (!__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val()) {
                    $button.prop('disabled', 'disabled');
                    return false;
        ...
        billingFunc.$form.find('#email').on('input propertychange paste', function () {
            if (billingFunc.checkEmailAgain) {
                const emailAddress = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val();
                const emailRegex = /[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/;

                if (emailRegex.test(emailAddress)) {
                    const formGroup = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#checkout01-form').find('#email');
                    const formParent = formGroup.parent();
                    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.help-block').remove();
    ...
    submitForm: function () {
        ...
        billingFunc.$form.submit(function (e) {
            ...
            if (features.hasValidEmail(emailAddress)) {
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()('button, input[type="button"]').blur();
                ...
                // display the spinner
                __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax('/cart/billing/submit', {
                    method: 'POST',
...
const shippingFunc = {
    init: function () {
        shippingFunc.$checkout02 = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.step02');
    ...
    submitForm: function () {
        ...
        shippingFunc.$form.submit(function (e) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax('/cart/shipping/submit', {
                method: 'POST',
                data: JSON.stringify(formObject()),
                dataType: 'text',
                contentType: 'application/json',
...
const paymentFunc = {
    init: function () {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#card-element')[0]) {
            paymentFunc.card.mount('#card-element');

            const $button = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.card-entry').find(':button').last();
    ...
    tokenHandler: function (token) {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax('/cart/stripeSubmit', {
            method: 'POST',
...
const modalAjaxHandler = {
    ...
    success: function(data) {
        if (data.allClear !== 'true') {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#modal-message').text(data.modalMessage);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#button-message').text(data.buttonMessage);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('a.modal-url').attr('href', data.buttonURL);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#info-missing-modal').modal({
                backdrop: 'static'
            });
        }
    }
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function () {
    ...
    if (document.getElementById('checkout') && document.getElementsByClassName('step01')[0]) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax('/cart/billing/checkIfReady', modalAjaxHandler);
    ...
    if (document.getElementById('checkout') && document.getElementsByClassName('step02')[0]) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax('/cart/shipping/checkIfReady', modalAjaxHandler);
        shippingFunc.init();
    ...
    if (document.getElementById('checkout') && document.getElementsByClassName('step03')[0]) {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax('/cart/confirmation/checkIfReady', modalAjaxHandler);
    }
